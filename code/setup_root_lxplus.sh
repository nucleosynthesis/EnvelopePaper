...
if [ "$scAr" = "slc6_amd64_gcc472" ] || [[ $vers == *6.* ]]; then
	...
	export PYTHONPATH=/afs/cern.ch/sw/lcg/external/Python/2.7.3/x86_64-slc6-gcc47-opt/bin:/afs/cern.ch/user/m/mkenzie/my-numpy/INSTALL/lib/python2.7/site-packages:$PWD:$PYTHONPATH
...
# SLC 5
	...
	export PYTHONPATH=/afs/cern.ch/sw/lcg/external/Python/2.7.3/x86_64-slc5-gcc47-opt/bin:/afs/cern.ch/user/m/mkenzie/my-numpy/INSTALL/lib/python2.7/site-packages:$PWD:$PYTHONPATH
