...
$\Lambda_{\mathrm{corr}}$ shape, and hence coverage, is unchanged. Both the 
exact p-value
...
In principle, these results could be used to choose an optimal value of $c$
...
no absolute method for determining this can be given.
