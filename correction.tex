...
\begin{figure}[tbp]
\centering
\begin{subfigure}[b]{0.5\textwdith}
...
in a fit with 160 bins.~\ref{fig:correction:DeltaChiSq:a} The change to the $\chi^2$ as a function of the
original p-value.~\ref{fig:correction:DeltaChiSq:b} The distribution of the change of
...
\centering
\begin{subfigure}[b]{0.5\textwdith}
\includegraphics[width=0.11\textwidth]{{correction/AllFunctionsLegend}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/ProfilesAllOrders0.0}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/EnvelopeAllOrders0.0}.pdf} 
\label{fig:correction:profile:a}
\end{subfigure}\\
\begin{subfigure}[b]{0.5\textwdith}
\includegraphics[width=0.11\textwidth]{{correction/AllFunctionsLegend}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/ProfilesAllOrders1.0}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/EnvelopeAllOrders1.0}.pdf} 
\label{fig:correction:profile:b}
\end{subfigure}\\
\begin{subfigure}[b]{0.5\textwdith}
\includegraphics[width=0.11\textwidth]{{correction/AllFunctionsLegend}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/ProfilesAllOrders2.0}.pdf}
\includegraphics[width=0.33\textwidth]{{correction/EnvelopeAllOrders2.0}.pdf}
\label{fig:correction:profile:c}
\end{subfigure}
