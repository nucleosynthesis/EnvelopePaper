...
Indeed, comparison to figure~\ref{fig:functions:profiles-pval} shows that the
...
\caption{(a) Profiled \nll curves for all of the functions considered. The \nll value for each profile curve has not been corrected using the approximate p-value correction of 1 per background parameter. The labels indicate the function and the value of $N_{\rm par}$. (b) Minimum envelope of the functions after applying a correction of 1 per background parameter to each \nll curve. The \nll scan when only considering the best fit function is shown in red.}
...
\caption{(a) Profiled \nll curves for all of the functions considered. The \nll value for each profile curve has not been corrected using the Akaike correction of 2 per background parameter. The labels indicate the function and the value of $N_{\rm par}$. (b) Minimum envelope of the functions after applying a correction of 2 per background parameter to each \nll curve. The \nll scan when only considering the best fit function is shown in red.}
...
\centering
\subfigure[]{
\includegraphics[width=0.46\textwidth]{{correction/AllOrderFunctions_Coverage_0.5_call}.pdf}
\label{fig:correction:allorderecoverage:a}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{{correction/AllOrderFunctions_Coverage_1._call}.pdf}
\label{fig:correction:allorderecoverage:b}
}\\
\subfigure[]{
\includegraphics[width=0.46\textwidth]{{correction/AllOrderFunctions_Coverage_2._call}.pdf}
\label{fig:correction:allorderecoverage:c}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{{correction/AllOrderFunctions_Coverage_3._call}.pdf}
...
The functions
used are (from the top panels): polynomial with $N_{\rm par}=6$,
