...
\nll shape, and hence coverage, is unchanged. Both the exact p-value
...
just the two-parameter functions (Sec~\ref{sec:functions:example}), but
...
Right: Minimum envelope of the functions considered accounting for the correction of 1 per 
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.48\textwidth]{{correction/AllOrderFunctions_Coverage_0.5_call}.pdf}
\includegraphics[width=0.48\textwidth]{{correction/AllOrderFunctions_Coverage_1._call}.pdf}\\
\includegraphics[width=0.48\textwidth]{{correction/AllOrderFunctions_Coverage_2._call}.pdf}
\includegraphics[width=0.48\textwidth]{{correction/AllOrderFunctions_Coverage_3._call}.pdf}
