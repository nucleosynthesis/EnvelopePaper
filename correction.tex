...
correction and the approximation are used in the rest of this paper.
%
\begin{figure}[tbp]
\centering
...
Figure~\ref{fig:correction:allorderbias} SHOWS STUFF

Figure~\ref{fig:correction:allordercoverage} SHOWS OTHER STUFF
...
Figure~\ref{fig:correction:compareerrors} shows the distribution of symmetrized uncertainty on $\mu$ 
